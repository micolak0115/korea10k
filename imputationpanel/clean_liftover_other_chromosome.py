...
if __name__ == "__main__":
    ...
    list_file_vcfs_filt = list(filter(lambda x: "hg38.liftover.vcf" in x, list_file_vcfs))
    for file_vcf in list_file_vcfs_filt:
        ...
        output_vcf = os.path.join(output_dir, file_vcf.replace(".vcf", ".cleaned.vcf"))
        jobname = f"{file_vcf}-BCFTOOLS-VIEW-liftover-other-chr-cleaned"
