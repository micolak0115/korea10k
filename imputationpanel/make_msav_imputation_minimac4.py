...
def run(minimac4, 
    ...
    cmd = f"{minimac4} --compress-reference {reference_panel_bcf} > {reference_panel_msav}"

    os.makedirs(os.path.dirname(reference_panel_msav), exist_ok=True)
