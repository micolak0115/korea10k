...
def run(bcftools,
    ...
    cmd = f'{bcftools} annotate --rename-chrs {chr_map} {input_vcf} -Oz -o {output_vcf} && {tabix} -p vcf {output_vcf}'
...
if __name__ == "__main__":
    ...
    for file_vcf in list_file_vcfs_filt:
        ...
        output_vcf = os.path.join(output_dir, file_vcf.replace(".vcf", ".chrname_fixed.vcf"))
        jobname = f"{file_vcf}-BCFTOOLS-ANNOTATE-chrname-fix"
